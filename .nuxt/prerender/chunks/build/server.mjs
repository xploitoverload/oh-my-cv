import { version, ref, watchEffect, watch, getCurrentInstance, unref, inject, useSSRContext, createApp, effectScope, shallowReactive, reactive, getCurrentScope, hasInjectionContext, mergeProps, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, defineAsyncComponent, computed, defineComponent, h, isReadonly, isRef, isShallow, isReactive, toRaw } from 'file:///workspaces/oh-my-cv/node_modules/.pnpm/vue@3.4.31_typescript@5.5.3/node_modules/vue/index.mjs';
import { $fetch } from 'file:///workspaces/oh-my-cv/node_modules/ofetch/dist/node.mjs';
import { b as baseURL } from '../_/renderer.mjs';
import { createHooks } from 'file:///workspaces/oh-my-cv/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs';
import { getContext } from 'file:///workspaces/oh-my-cv/node_modules/.pnpm/unctx@2.3.1/node_modules/unctx/dist/index.mjs';
import { sanitizeStatusCode, createError as createError$1 } from 'file:///workspaces/oh-my-cv/node_modules/.pnpm/h3@1.12.0/node_modules/h3/dist/index.mjs';
import { hasProtocol, isScriptProtocol, joinURL, withQuery, isEqual, stringifyParsedURL, stringifyQuery, parseQuery } from 'file:///workspaces/oh-my-cv/node_modules/ufo/dist/index.mjs';
import { CapoPlugin, getActiveHead } from 'file:///workspaces/oh-my-cv/node_modules/.pnpm/unhead@1.9.15/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin, composableNames } from 'file:///workspaces/oh-my-cv/node_modules/.pnpm/@unhead+shared@1.9.15/node_modules/@unhead/shared/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///workspaces/oh-my-cv/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs';
import { defu } from 'file:///workspaces/oh-my-cv/node_modules/defu/dist/defu.mjs';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file:///workspaces/oh-my-cv/node_modules/.pnpm/vue@3.4.31_typescript@5.5.3/node_modules/vue/server-renderer/index.mjs';
...
const router_tW9czXAscy = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:router",
  enforce: "pre",
  setup(nuxtApp) {
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.12.3_@parcel+watcher@2.4.1_@types+node@20.14.10_eslint@9.6.0_ioredis@5.4.1_magicast@0._zbg4noxekcn2dah5lk5lam6gna/node_modules/nuxt/dist/app/components/welcome.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-9e0a9727"]]);
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BgxWuV8B.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-wuEsodiD.mjs').then((r) => r.default || r));
